...
import '../presentation/pages/customer/products_page.dart' as customer;
import '../presentation/pages/technician/area_calculator_page.dart' as tech;
    ...
    routes: [
      ...
      GoRoute(
        ...
        routes: [
          GoRoute(
            path: 'products',
            builder: (context, state) => const customer.ProductsPage(),
          ),
          GoRoute(
            path: 'services',
